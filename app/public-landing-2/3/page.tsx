...
export default function Page() {
          ...
          setPlaybook({
            template: {
              ...
              buttonText: campaignData.data.outcomeTemplate?.buttonText ||
                campaignData.data.template?.buttonText || "Download the Report",
              ...
              mediaUrl: campaignData.data.outcomeTemplate?.mediaUrl ||
                campaignData.data.template?.mediaUrl || "/partner-integrations/report.png",
            },
            recipient: {
  ...
  return (
    <div className="relative bg-gradient-to-r shadow-lg from-[#ECFCFF] to-[#E8C2FF] min-h-screen">
      ...
      <div className="relative w-full flex flex-col md:flex-row items-start gap-8 md:gap-20 px-6 md:px-[10%] pt-8 md:pt-0">
        {/* Col 1: Text Content */}
                ...
                >
                  <button className="flex w-fit hover:opacity-95 text-lg md:text-xl duration-300 items-center gap-3 bg-primary text-white font-semibold px-4 md:px-5 py-2 md:py-2.5 rounded-lg">
                    <Image
                      ...
                      height={24}
                    />
                    {playbook.template.buttonText || "Download the Report"}
                  </button>
                </a>
              </div>
            )}
        ...
        <div className="w-full md:w-[55%] mt-6 md:mt-0 relative">
          <Image
            src={playbook.template?.mediaUrl || "/partner-integrations/report.png"}
            alt="Report Image"
